...
goog.provide('proto.helloworld.Person');
...
proto.helloworld.Person = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.helloworld.Person.oneofGroups_);
};
 ...
 * @const
 */
proto.helloworld.Person.oneofGroups_ = [[2,3]];

/**
 * @enum {number}
 */
proto.helloworld.Person.ContactCase = {
  CONTACT_NOT_SET: 0,
  EMAIL: 2,
  MOBILE: 3
};
...
/**
 * @return {proto.helloworld.Person.ContactCase}
 */
proto.helloworld.Person.prototype.getContactCase = function() {
  return /** @type {proto.helloworld.Person.ContactCase} */(jspb.Message.computeOneofCase(this, proto.helloworld.Person.oneofGroups_[0]));
};
...
proto.helloworld.Person.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    mobile: jspb.Message.getField(msg, 3)
  };
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.helloworld.Person.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getName();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.helloworld.Person} The clone.
 */
proto.helloworld.Person.prototype.cloneMessage = function() {
  return /** @type {!proto.helloworld.Person} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {string?}
 */
proto.helloworld.Person.prototype.getEmail = function() {
  return /** @type {string?} */ (jspb.Message.getField(this, 2));
};


/** @param {string?|undefined} value  */
proto.helloworld.Person.prototype.setEmail = function(value) {
  jspb.Message.setOneofField(this, 2, proto.helloworld.Person.oneofGroups_[0], value);
};


proto.helloworld.Person.prototype.clearEmail = function() {
  jspb.Message.setOneofField(this, 2, proto.helloworld.Person.oneofGroups_[0], undefined);
};
 ...
 * @return {number?}
 */
proto.helloworld.Person.prototype.getMobile = function() {
  return /** @type {number?} */ (jspb.Message.getField(this, 3));
};


/** @param {number?|undefined} value  */
proto.helloworld.Person.prototype.setMobile = function(value) {
  jspb.Message.setOneofField(this, 3, proto.helloworld.Person.oneofGroups_[0], value);
};
