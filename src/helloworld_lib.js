...
goog.provide('proto.helloworld.HelloRequestNew');
 ...
 * @constructor
 */
proto.helloworld.HelloRequestNew = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.helloworld.HelloRequestNew.oneofGroups_);
};
goog.inherits(proto.helloworld.HelloRequestNew, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.helloworld.HelloRequestNew.displayName = 'proto.helloworld.HelloRequestNew';
}
/**
 ...
 * @const
 */
proto.helloworld.HelloRequestNew.oneofGroups_ = [[2,3]];
 ...
 * @return {!Object}
 */
proto.helloworld.HelloRequestNew.prototype.toObject = function(opt_includeInstance) {
  return proto.helloworld.HelloRequestNew.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.helloworld.HelloRequestNew} msg The msg instance to transform.
 * @return {!Object}
 */
proto.helloworld.HelloRequestNew.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: msg.getName(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.helloworld.HelloRequestNew}
 */
proto.helloworld.HelloRequestNew.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.helloworld.HelloRequestNew;
  return proto.helloworld.HelloRequestNew.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.helloworld.HelloRequestNew} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.helloworld.HelloRequestNew}
 */
proto.helloworld.HelloRequestNew.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.helloworld.HelloRequestNew} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.helloworld.HelloRequestNew.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.helloworld.HelloRequestNew.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.helloworld.HelloRequestNew.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getName();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.helloworld.HelloRequestNew} The clone.
 */
proto.helloworld.HelloRequestNew.prototype.cloneMessage = function() {
  return /** @type {!proto.helloworld.HelloRequestNew} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {string}
 */
proto.helloworld.HelloRequestNew.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldProto3(this, 1, ""));
};


/** @param {string} value  */
proto.helloworld.HelloRequestNew.prototype.setName = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {number?}
 */
proto.helloworld.HelloRequestNew.prototype.getMobile = function() {
  return /** @type {number?} */ (jspb.Message.getField(this, 2));
};


/** @param {number?|undefined} value  */
proto.helloworld.HelloRequestNew.prototype.setMobile = function(value) {
  jspb.Message.setOneofField(this, 2, proto.helloworld.HelloRequestNew.oneofGroups_[0], value);
};


proto.helloworld.HelloRequestNew.prototype.clearMobile = function() {
  jspb.Message.setOneofField(this, 2, proto.helloworld.HelloRequestNew.oneofGroups_[0], undefined);
};
